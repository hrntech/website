                                    ...
                                    <div class="col d-flex justify-content-center">
                                        <div class="qna" data-target="q4">
                                            ...
                                            <div id="q4" class="answer">
                                                <p>We use modern frameworks like React, Angular, Node.js, Laravel, and Django to build scalable and responsive websites.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-5">
                                    <div class="col d-flex justify-content-center">
                                        <div class="qna" data-target="q1">
                                            <div class="question">
                                                <span><img src="assets/images/right-arrow.png" alt=""></span>
                                                <h3>Do you provide custom software solutions?</h3>
                                            </div>
                                            <div id="q1" class="answer">
                                                <p>Yes, we specialize in tailor-made ERP, CRM, and enterprise software based on your business needs.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-5">
                                    <div class="col d-flex justify-content-center">
                                        <div class="qna" data-target="q2">
                                            <div class="question">
                                                <span><img src="assets/images/right-arrow.png" alt=""></span>
                                                <h3>How do you measure digital marketing success?</h3>
                                            </div>
                                            <div id="q2" class="answer">
                                                <p>We track KPIs like traffic, leads, conversions, and ROI using analytics tools.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col d-flex justify-content-center">
                                        <div class="qna" data-target="q3" style="border:none">
                                            <div class="question">
                                                <span><img src="assets/images/right-arrow.png" alt=""></span>
                                                <h3>Do you develop apps for both Android and iOS?</h3>
                                            </div>
                                            <div id="q3" class="answer">
                                                <p>Yes, we create native apps for Android/iOS as well as cross-platform apps using Flutter & React Native.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
